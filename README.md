...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create web-0c9f
  fly apps create web-0c9f-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app web-0c9f
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app web-0c9f-staging
  ```
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name web-0c9f-db
  fly postgres attach --app web-0c9f web-0c9f-db

  fly postgres create --name web-0c9f-staging-db
  fly postgres attach --app web-0c9f-staging web-0c9f-staging-db
  ```
